...
- [(고급) 자녀가 둘 이상이거나 AI 편지를 끄고 싶을 때](#-고급-자녀가-둘-이상이거나-ai-편지를-끄고-싶을-때)
...
다른 자녀를 백업하려면 `Run workflow` 화면의 **`child_name`** 칸에 자녀 이름을 입력하세요 (예: `유주`). 자세한 가이드는 [👨‍👩‍👧‍👦 (고급) 자녀가 둘 이상이거나 AI 편지를 끄고 싶을 때](#-고급-자녀가-둘-이상이거나-ai-편지를-끄고-싶을-때) 섹션을 참고하세요.
